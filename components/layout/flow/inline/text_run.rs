...
use fonts::{
    ByteIndex, FontContext, FontRef, ShapedTextSlice, ShapingFlags, ShapingOptions, TextByteRange,
};
...
impl FontAndScriptInfo {
    ...
    pub(crate) fn eq_ignoring_script(self: &Arc<Self>, other: &Arc<Self>) -> bool {
